        ...
        <div className="flex gap-x-2 items-center justify-center md:justify-start mt-5">
          {headings.map((heading, i) => (
            <div className="flex gap-x-1 md:gap-x-2 items-center" key={i}>
              <img src={heading.img} alt="" className="w-6 h-6 md:w-8 md:h-8" />
          ...
          <div className="border-2 rounded-2xl p-3 md:p-5 lg:p-6">
            ...
            <div className="divide-y-2 space-y-3">
              <div className="flex justify-between items-center">
                ...
                <img src={usdc} alt="" className="w-6 h-6" />
              </div>
              <div className="flex justify-between flex-wrap gap-1 md:gap-0 pt-3">
                ...
                <p className="w-[30%]">
                  Current APR <span className="block text-xl">3.84%</span>
                </p>

                <p className="w-[30%]">
                  Average APR {/* ----tooltip here---- */}{" "}
            ...
            <div className="divide-y-2 space-y-3">
              {collateralParameters.map((scheme, i) => (
                <p key={i} className="pt-3">
                  {scheme.name} {/* tooltip here */}
                  <span className="block text-xl">{scheme.rate}</span>
                </p>
              ))}
            </div>
          </aside>
          ...
          <aside className="border-2 rounded-2xl p-3 md:p-5 lg:p-6">
            ...
            <div className="divide-y-2 space-y-3">
              <div className="flex justify-between mt-1">
                ...
                <img src={compund} alt="" className="w-6 h-6" />
              </div>
              <div className="pt-3">
                <p>Rewards Rate</p>
